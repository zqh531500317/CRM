...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="container">
                <form action="<%=request.getContextPath()%>/linkMan/add" method="post" class="form-horizontal"
                    ...
                    <div class="row form-group">
                        <label for="file" class="col-md-1 col-xs-1" style="position: relative;left: 10px">附件</label>
                        <div class="col-md-3 col-xs-3">
